...
(function() {
  ...
  var NOTIFY_URL = "https://script.google.com/macros/s/AKfycbwKrrzepBq5XTxuEJCcHKkYCACWlWxBt2ftkYM3yxPTTXyTAEAyPIFN5MmuAszNgMqV3A/exec";
  var _sb;
  ...
  function hookGenerateOrder() {
    ...
    window.generateOrder = function() {
      ...
      // Save to Supabase
      _sb.from('orders').insert(orderData).then(function(res) {
        if (res.error) {
